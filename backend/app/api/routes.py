...
from app.api.models import TicketRequest, PredictionResponse
...
async def predict_ticket(ticket: TicketRequest):
    ...
    try:
        ...
        logger.info(f"✅ Prediction complete: ticket_id={ticket_id} | {result['category']} | {result['priority']} | {result['sentiment']}")
